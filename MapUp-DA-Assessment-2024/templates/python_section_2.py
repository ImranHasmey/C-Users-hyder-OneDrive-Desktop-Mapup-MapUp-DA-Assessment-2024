...
# Load the dataset
file_path = r"C:\Users\hyder\OneDrive\Desktop\Mapup\MapUp-DA-Assessment-2024\submissions\excel_assessment.xlsx"
...
# Load the dataset
file_path = r"C:\Users\hyder\OneDrive\Desktop\Mapup\MapUp-DA-Assessment-2024\datasets\dataset-2.csv"
...
def calculate_time_based_toll_rates(df):
    ...
    for index, row in df.iterrows():
        ...
        discount = 0.7 if start_day in ["Saturday", "Sunday"] else (0.8 if datetime.time(0, 0) <= datetime.time(10, 0) else (1.2 if datetime.time(10, 0) < datetime.time(18, 0) else 0.8))
        for vehicle in ['moto', 'car', 'rv', 'bus', 'truck']:
            df.at[index, vehicle] *= discount
        df.at[index, 'start_day'] = start_day
        df.at[index, 'start_time'] = datetime.time(0, 0)
        df.at[index, 'end_day'] = start_day
        df.at[index, 'end_time'] = datetime.time(23, 59, 59)
    return df
